//Command to run:
//			nodemon C:\Users\Mez\Desktop\WebApi\apiHw4\movieServer.js localhost 1337
...
function addEntity () {
   ...
   var options = {
	   ...
	   type:'movie' //the entity type associated with our collection
   }				   
   ...
   collection.addEntity(properties, function (error, response){
	  if (error) {
          ...
          +	  "and..."
			...
			var entityArray = [
			   {
				   type:'movie', //the entity type should correspond to the collection type
				   title:'Interstellar'
				   released:'2014'
			   },
			   {
